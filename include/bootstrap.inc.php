...
include "../admin/include/coverage.inc.php";
...
if (isset($_GET["file"])) {
	include "../admin/file.inc.php";
}

include "../admin/include/functions.inc.php";
...
include "../admin/include/lang.inc.php";
include "../admin/lang/lt.inc.php";
include "../admin/include/pdo.inc.php";
include "../admin/include/driver.inc.php";

include "../admin/drivers/mysql.inc.php"; // must be included as last driver
...
include "../admin/include/design.inc.php";
include "../admin/include/xxtea.inc.php";
include "../admin/include/auth.inc.php";
